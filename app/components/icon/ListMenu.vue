<template>
    <svg width="30" height="30" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 380 380"
        ...
        <g id="XMLID_1244_">
            ...
            <path id="XMLID_1247_" style="fill:#DEDDE0;"
                d="M170.001,330v-30h20v-30h-20v-30h20v-30h-20v-30h20v-30h-50v-30h50V90h-0.001H40
            ...
            <polygon id="XMLID_1253_" style="fill:#FFFFFF;"
                points="170.001,330 190.001,330 270,330 270,300 190.001,300 170.001,300 	" />
            <rect id="XMLID_1254_" x="110.001" y="240" style="fill:#64C37D;" width="30" height="30" />
            <polygon id="XMLID_1255_" style="fill:#FFFFFF;"
                points="170.001,270 190.001,270 270,270 270,240 190.001,240 170.001,240 	" />
            <rect id="XMLID_1256_" x="110.001" y="180" style="fill:#64C37D;" width="30" height="30" />
            <polygon id="XMLID_1257_" style="fill:#FFFFFF;"
                points="170.001,210 190.001,210 270,210 270,180 190.001,180 170.001,180 	" />
