        ...
        <div class="w-full">
                                                ...
                                                <th v-for="col in columns" :key="col.key" scope="col"
                                                        ...
                                                        <div class="flex items-center">
                                                                ...
                                                                <span v-if="col.sortable" class="ml-1">
                                                                        <UIcon v-if="sortKey === col.key && sortOrder === 'asc'"
                                                                                name="i-heroicons-bars-arrow-up"
                                                                                class="w-3.5 h-3.5" />
                                                                        <UIcon v-else-if="sortKey === col.key && sortOrder === 'desc'"
                                                                                name="i-heroicons-bars-arrow-down"
                                                                                class="w-3.5 h-3.5" />
                                                                        <UIcon v-else name="i-heroicons-arrows-up-down"
                ...
                <div class="flex justify-between items-center flex-wrap gap-3">
                        <div class="flex items-center gap-4">
                                ...
                                <UPagination :model-value="currentPage" :page-count="rowsPerPage"
