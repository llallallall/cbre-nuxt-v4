...
export const useAddressProcessor = () => {
        ...
        const searchAddressCandidates = async (query: string): Promise<GeocodingCandidate[]> => {
                try {
                        ...
                        return new Promise((resolve, reject) => {
                                geocoder.geocode({ address: query }, (results: any[], status: any) => {
                                        if (status === 'OK' && results) {
                                                const candidates = results.map((res: any, idx: number) => ({
                                                        id: res.place_id,
                        ...
                        console.error('Error in searchAddressCandidates:', e);
                        return [];
                }
        };
                ...
                try {
                        ...
                        return new Promise((resolve, reject) => {
                                ...
                                if (lat && lng) {
                                        ...
                                        geocoder.geocode({ address: candidate.addressKorean }, (results: any[], status: any) => {
                        ...
                        console.error('Error in processSelectedAddress:', e);
                        return null;
                }
        };
