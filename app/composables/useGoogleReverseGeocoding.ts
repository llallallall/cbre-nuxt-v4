...
export function useGoogleReverseGeocoding() {
        ...
        const getEnglishAddressComponents = async (
                lat: number,
                lng: number
                ...
                try {
                        ...
                        return new Promise((resolve) => {
                                ...
                                geocoder.geocode({ location: latlng, language: 'en' }, (results: any[], status: any) => {
                                        ...
                                        const sublocality = components.find((comp: any) => comp.types.includes('sublocality'))?.long_name;
                        ...
                        console.error('Error in getEnglishAddressComponents:', e);
                        return null;
                }
        };
