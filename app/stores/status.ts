...
export const useStatusStore = defineStore('status', {
    ...
    actions: {
        ...
        /**
         * @description Confirm 모달을 엽니다. (Promise 기반)
         * @param message - 모달에 표시될 메시지
         * @param title - 모달 제목 (선택 사항)
         * @returns Promise<boolean> - 확인(true) 또는 취소(false)
         */
        openConfirmModal(message: string, title: string = 'Confirm Action'): Promise<boolean> {
        ...
        /**
         * @description Confirm 모달을 닫고 Promise를 resolve합니다.
        ...
        closeConfirmModal(confirmed: boolean) {
            ...
            this.confirmModalTitle = 'Confirm Action';
