...
<template>
  <div class="relative w-full h-screen overflow-hidden font-notoSans">
    ...
    <div class="relative z-20 flex flex-col items-center justify-center min-h-screen p-4">
      <div
        class="bg-white p-8 md:p-12 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center text-center max-w-md w-full backdrop-blur-sm bg-white/90">
        <!-- Icon -->
        ...
        <button @click="handleError"
          class="px-6 py-2.5 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-primary transition-colors font-calibreMedium mb-8 text-sm">
          Back to Home
        </button>
